    ...
    <div class="w-full max-w-xl mx-auto p-4 rounded-lg bg-white border border-gray-300">
        <form method="POST" action="{{}}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="file" class="form-control-file" id="file" name="file" accept="image/*" multiple max="3000000">
            </div>
            <button type="submit" class="btn bg-indigo-500 text-white py-2 px-4 rounded-lg hover:bg-indigo-600">Publish</button>
        </form>
    </div>
@stop
